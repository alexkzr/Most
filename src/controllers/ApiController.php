...
- В тексте могут встречаться плейсхолдеры вида __IMG_0__, __IMG_1__ и т.д. — это временные метки изображений. Сохраняй их БЕЗ ИЗМЕНЕНИЙ, на том же месте в тексте, не удаляй и не переноси.
